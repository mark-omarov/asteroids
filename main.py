...
from ui import show_game_over_screen, show_start_menu
...
def main():
    ...
    show_start_menu(screen, bg_image, font)
    ...
    while game_running:
        ...
        while True:
                ...
                for asteroid in asteroids:
                    if asteroid.collides_with(player):
                        ...
                        if game_manager.game_over:
                            ...
                            if show_game_over_screen(screen, bg_image, font, game_manager.score):
                                break
                            else:
                                game_running = False
                                break
            ...
            dt = clock.tick(60) / 1000 # limit 60 FPS
